...
function HeroSection() {
    ...
    const timeLine = () => {
        return (
            <div >
                <div className="text-xl heading-cl font-bold">Timeline</div>
    ...
    return (
            ...
            <div className="inter primary-bg text-cl px-4 md:px-8 py-4 flex space-x-8">
                <div className="md:w-[70%]">
                <div className="md:hidden mt-2 mb-6">
                    {timeLine()}
                </div>
                    <div className="mb-6">
                        <div className="heading-cl text-xl font-bold">Welcome to ReACS 2025</div>
                        <div className="text-[12px] mt-2">Recent Advances in Computing and Systems - 2025</div>
                    </div>
                    <div className="mb-6">
                        <div className="heading-cl text-xl font-bold">About ReACS</div>
                        <div className="text-[12px] mt-2">The International Conference on Recent Advances in Computing and Systems, 2025 (ReACS-2025) is being organised by the Department of CSE, ABV-IIITM, to functionalize it as a platform for dissemination of recent high-quality research work in the domain of Computing and Systems. This conference covers the wide domain of Computer Science and Engineering and will provide a means to exchange innovative ideas and recent advances among researchers from academia and industry.</div>
                    </div>
                    <div>
                        <div className="heading-cl text-xl font-bold">Regular Tracks</div>
                        {RegularTracks.map((item) => (
                            <div className="mt-2">
                            <div className="heading-cl text-md font-semibold">{item.heading}</div>
                            <div className="text-[12px] mt-1">{item.content}</div>
                        </div>
                        ))}
                        {/* <div className="mt-2">
